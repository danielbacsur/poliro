...
<html>
    ...
    <body>
        ...
        if(isset($_POST['login'])){
            ...
            $account_pass = hash('sha256', $_POST['password']);

            $get_email = "SELECT * FROM accounts WHERE account_mail='$account_mail' AND account_pass='$account_pass'";
        ...
        if(isset($_POST['signup'])){
            ...
            $get_email = "SELECT * FROM accounts WHERE account_mail='$account_email'";
            $run_email = mysqli_query($db,$get_email);
            $check_email = mysqli_num_rows($run_email);
            if($check_email == 1){
