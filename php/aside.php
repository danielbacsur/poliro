  <aside class="sidenav navbar navbar-vertical border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php if($root_filename== 'dashboard.php') echo 'active'; ?> " href="../pages/dashboard.php">
            ...
            <span class="nav-link-text ms-1">Kezelőfelület</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if($root_filename== 'tasks.php') echo 'active'; ?> " href="../pages/tasks.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
